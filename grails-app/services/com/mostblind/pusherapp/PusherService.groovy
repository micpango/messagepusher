...
class PusherService {
  ...
  final def pusherHost = config.pusherHost
  final def pusherApplicationId = config.pusherApplicationId
  final def pusherApplicationKey = config.pusherApplicationKey
  final def pusherApplicationSecret = config.pusherApplicationSecret
