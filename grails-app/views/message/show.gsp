...
<%@ page import="com.mostblind.messagepusher.Message" %>
<html>
    <head>
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="message.user.label" default="User" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: messageInstance, field: "user")}</td>
